                        ...
                        <div class="header_container d-flex flex-row align-items-center justify-content-start">
                            ...
                            <nav class="main_nav ml-auto">
                                <ul class="main_nav_list">
                                    ...
                                    <li class="main_nav_item"><a href="../../../travel/travel-info/client/about.html">Về Chúng Tôi</a></li>
                                    <li class="main_nav_item"><a href="../../../travel/travel-info/client/contact.html">Liên hệ</a></li>
            ...
            <div class="menu_inner menu_mm">
                <div class="menu menu_mm">
                    ...
                    <ul class="menu_list menu_mm">
                        ...
                        <li class="menu_item menu_mm"><a href="../../../travel/travel-info/client/about.html">Về Chúng Tôi</a></li>
                        <li class="menu_item menu_mm"><a href="../../../travel/travel-info/client/contact.html">Liên hệ</a></li>
                            ...
                            <div class="newsletter_form_container">
                                <form action="#" id="newsletter_form" class="newsletter_form">
                                    <div class="d-flex flex-md-row flex-column align-content-center justify-content-between">
                                        <input type="email" id="newsletter_input" class="newsletter_input" placeholder="Địa chỉ e-mail của bạn">
                                        <button type="submit" id="newsletter_button" class="newsletter_button">Đăng ký</button>
                                    </div>
                                </form>
                            </div>
                        </div>
